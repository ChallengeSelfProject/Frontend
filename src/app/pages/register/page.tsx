  ...
  return (
    <div className="flex justify-center min-h-screen">
      <div className="max-w-screen-2xl flex justify-center flex-1 bg-global">
        <div className="flex flex-col w-4/5 py-6 sm:w-11/12 md:w-10/12 lg:w-1/2 xl:w-6/12 sm:p-12 lg:items-center lg:justify-center">
          <AuthTemplate>
            <FormRegister />
          </AuthTemplate>
          <div className="py-3 flex items-center text-xs text-gray-400  before:flex-1 before:border-t before:border-gray-400 before:me-2 after:flex-1 after:border-t after:border-gray-400 after:ms-2">
            atau
          </div>
